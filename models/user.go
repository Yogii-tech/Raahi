...
type User struct {
	...
	VerificationStatus string             `bson:"verification_status,omitempty" json:"verification_status"` // "pending", "verified", "rejected"
	RejectionReason    string             `bson:"rejection_reason,omitempty" json:"rejection_reason"`
